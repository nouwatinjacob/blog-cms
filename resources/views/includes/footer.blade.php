                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        ...
                        <p class="heading-text">
                            Node is associated with JavaScript and JavaScript is the Hillary Clinton of programming — many, many people harbor an irrational hatred of JavaScript, and that carries over into Node.
                            The truth is that Node revolutionized production systems. Its UNIX roots are strong, its support for C++ is complete, and you will love working in it.
                        </p>
                    </div>
                </div>
            </div>
